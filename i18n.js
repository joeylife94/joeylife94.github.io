 ...
 *
 * Source-of-truth note: hero/services/featured/faq/contact copy should be edited here first,
 * then kept in sync with index.html data-i18n keys.
 */
(function () {
  'use strict';
  ...
  var translations = {
    ko: {
      ...
      'hero-h1': '스프레드시트, Slack, 수작업으로 운영 중인 팀을 위한 내부 도구·워크플로우·백엔드 MVP를 만듭니다.',
      ...
      'card-papyrus-desc': '문제: 팀 지식이 문서/메시지에 분산돼 최신 기준 확인에 시간이 들었습니다. 시스템: 실시간 협업 위키와 권한 기반 편집 흐름을 구축했습니다.',
      'card-papyrus-proof': '운영 결과: 같은 정보를 반복 정리하는 시간을 줄이고, 팀이 같은 기준으로 더 빠르게 의사결정하게 됐습니다.',
      ...
      'form-helper-label': '아래 4가지만 보내주시면 범위 판단이 빠릅니다.',
    ...
    en: {
      ...
      'hero-h1': 'I build internal tools, workflow systems, and backend MVPs for teams still running operations through spreadsheets, Slack, and manual work.',
      ...
      'card-seoulgyeol-proof': 'Operational outcome: faster consultation prep and consistent report delivery without manual follow-up.',
      'card-restricted-desc': 'Problem: sensitive ops requests were buried in chat, making approval and tracking unreliable. System: only approved Slack requests were converted into structured ops records.',
      'card-restricted-proof': 'Operational outcome: fewer missed/duplicate requests and faster downstream handling with an auditable trail.',
      'card-papyrus-desc': 'Problem: team knowledge was fragmented across docs and messages, slowing execution. System: real-time collaborative wiki with role-based editing and workflow structure.',
      'card-papyrus-proof': 'Operational outcome: less repeated clarification work and faster decisions on a shared source of truth.',
      ...
      'contact-intro': 'Email your current operational bottleneck and desired outcome.<br />I\'ll review scope and reply with the most practical first step.',
    ...
    ja: {
      ...
      'hero-h1': 'スプレッドシート・Slack・手作業で回っている運用を、社内ツール・ワークフローシステム・バックエンドMVPに変えます。',
      ...
      'card-restricted-desc': '課題: 機微な運用依頼がチャットに埋もれ、承認と追跡が不安定でした。システム: 承認済みSlack依頼のみを構造化レコード化。',
      'card-restricted-proof': '運用成果: 依頼の漏れ・重複を減らし、監査可能な履歴で後続処理を高速化しました。',
      'card-papyrus-desc': '課題: チーム知識が文書とメッセージに分散し、最新基準の確認に時間がかかっていました。システム: リアルタイム共同編集Wikiと権限ベース運用を整備。',
      'card-papyrus-proof': '運用成果: 情報の再整理作業を減らし、同じ基準での意思決定を速めました。',
      ...
      'contact-intro': '現在の運用ボトルネックと望む結果をメールでお送りください。<br />スコープを確認し、最初の実行ステップをご返信します。',
      'form-label-name': 'お名前 *',
      ...
      'form-helper-label': 'まずは次の5点だけで十分です。',
      'form-helper-1': 'まだ手作業の業務を1〜2件',
